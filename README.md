...
- 최민석
  ...
  - 느낀점: 전공 지식을 십분 활용할 수 있는 수업의 프로젝트여서 즐겁게 임할 수 있었던 것 같다. 잘 따라와준 팀원들에게 감사하다.

- 김동석
  - 역할: 하드웨어 제작, 커버 디자인, 스타트 펌웨어 개선, 자료 관리
  - 느낀점: 다들 역할에 맞게 열심히 프로젝트를 수행함에 있어서 만족스러웠으며, 잘 이끌어준 팀원들이 너무나 감사했다.

- 한지호
  - 역할: 회로도 제작, 기본 통신 개발, 피니쉬 라인 펌웨어 개발, 프로젝트 관리
  - 느낀점: 기본적으로 프로젝트 볼륨이 도중에 커졌지만 다들 잘 따라와줘서 마무리에 문제가 없었다. 다만 모터의 출력이 아쉬웠던 부분이 존재했다.

- 공성우
  - 역할: 도트 매트릭스 펌웨어 제작, 스타트 라인 펌웨어 개발, RC카 제작
  - 느낀점: 여러가지 다양한 모듈을 활용해서 직접 구현을 해볼 수 있어서 즐거웠다. 제시한 아이디어를 끝까지 지지해주고 서포트 해준 팀원들에게 감사하다.